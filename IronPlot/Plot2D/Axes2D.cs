...
namespace IronPlot
{
    ...
    public class Axes2D : DependencyObject
    {
        ...
        internal XAxis xAxisBottom; 
        internal YAxis yAxisLeft;
        ...
        internal void UpdateAxisPositions()
        {
            ...
            if (xAxesBottom.FirstOrDefault() != null) xAxesBottom.First().IsInnermost = true;
            if (xAxesTop.FirstOrDefault() != null) xAxesTop.First().IsInnermost = true;
            if (yAxesLeft.FirstOrDefault() != null) yAxesLeft.First().IsInnermost = true;
            if (yAxesRight.FirstOrDefault() != null) yAxesRight.First().IsInnermost = true;
        }
